...
//compose message
        try {
            ...
            message.setSubject("Data Backup From  levelup_oppo");
                        
        MimeBodyPart messageBodyPart = new MimeBodyPart();
        Multipart multipart = new MimeMultipart();
       
        String file = "D:\\Level Up\\Backup File\\levelup_oppo_new.sql";
        
        String fileName = "levelup_oppo_new.sql";
        ...
        message.setContent(multipart);
            ...
            File f=new File("D:\\Level Up\\Backup File\\levelup_oppo_new.sql");
            f.delete();
